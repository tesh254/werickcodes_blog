<style>
  header {
    ...
    background: #0a0a0a;
    background: var(--theme-container-background, #0a0a0a);
    border-radius: 3px;
    border: 2px solid #a8adb0 !important;
    box-shadow: 5px 6px 0px #a8adb0 !important;
  }
  .profile {
    display: flex;
    align-items: center;
  ...
  .profile-image {
    ...
    max-width: 220px;
    max-height: 220px;
    border: 4px solid #a8adb0 !important;
  }
  .icon-img {
    margin-right: 1em;
    width: 35px;
...
<header>
  <div class="flex-container">
    <div class="profile">
      <img
        class="profile-image img-profile"
        src="https://res.cloudinary.com/practicaldev/image/fetch/s--EN_HeXlK--/c_fill,f_auto,fl_progressive,h_320,q_auto,w_320/https://thepracticaldev.s3.amazonaws.com/uploads/user/profile_image/135717/cc5f2154-58de-4568-8042-1dc83f967432.jpeg"
        alt="erickwachira profile" />
    </div>
    <div class="profile-description">
      ...
      <div class="social">
        ...
        <a href="https://github.com/tesh254" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="438.549"
            height="438.549"
        ...
        <a href="https://me.werick.codes">
          <svg
            ...
            xml:space="preserve"
            role="img"
            aria-labelledby="a3n420hyeu4yx5mooei2rguhp8jdl70z"
            class="icon-img">
            <title id="a3n420hyeu4yx5mooei2rguhp8jdl70z">
              external link icon
            </title>
            <g>
              <g>
